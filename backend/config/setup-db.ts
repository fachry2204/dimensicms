...
const setupDatabase = async () => {
  ...
  try {
    ...
    const [users]: any = await connection.query('SELECT * FROM users WHERE email = ?', ['admin@musicaggregator.com']);
    ...
    const [aggregators]: any = await connection.query('SELECT * FROM aggregators');
